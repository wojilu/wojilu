...
namespace wojilu.Web.Controller.Shop.Admin {
    ...
    public class SectionSettingController : ControllerBase {
        ...
        private void bindSettingEdit( ShopSection section, Service service ) {
        ...
        public void UpdateBinder( int id ) {
            ...
            section = ShopValidator.ValidateSectionEdit( section, ctx );
            if (errors.HasErrors) {
                run( EditBinder, id );
                return;
            }
        ...
        public static void updateParamValues( ShopSection section, IShopSectionService sectionService, MvcContext ctx ) {
