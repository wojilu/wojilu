...
namespace wojilu.Web.Controller.Shop {
    ...
    public partial class ShopController : ControllerBase {
        ...
        private void bindRows( ShopApp article, List<ShopSection> sections ) {
        ...
        private String getTitle( ShopSection section, String moreUrl ) {
        ...
        private String getMoreUrl( ShopSection section ) {
        ...
        private String getSectionContent( ShopSection section ) {
            String content;
        ...
        private String getData( ShopSection articleSection ) {
        ...
        private String getAutoData( ShopSection section ) {
            ...
            ShopSectionTemplate sectionTemplate = TplService.GetById( section.TemplateId );
