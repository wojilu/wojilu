...
b){b="number"==typeof b?b:a.parentNode.rowIndex;this.table.rows[b].deleteCell(a.cellIndex)},getCellsRange:function(a,b){function c(a,b,e,f){var g=a,h=b,j=e,k=f,l,m,n;if(0<a)for(m=b;m<f;m++)l=d.indexTable[a][m],n=l.rowIndex,n<a&&(g=Math.min(n,g));if(f<d.colsNum)for(n=a;n<e;n++)l=d.indexTable[n][f],m=l.colIndex+l.colSpan-1,m>f&&(k=Math.max(m,k));if(e<d.rowsNum)for(m=b;m<f;m++)l=d.indexTable[e][m],n=l.rowIndex+l.rowSpan-1,n>e&&(j=Math.max(n,j));if(0<b)for(n=a;n<e;n++)l=d.indexTable[n][b],m=l.colIndex,
...
e.colSpan,c);a.moveToBookmark(b).select()}};UE.commands.deletecol={queryCommandState:function(){return!w(this).cell?-1:0},execCommand:function(){var a=w(this).cell,b=F(a),c=b.cellsRange,d=b.getCellInfo(a),e=b.getHSideCell(a),g=b.getHSideCell(a,!0);if(p.isEmptyObject(c))b.deleteCol(d.colIndex);else for(d=c.beginColIndex;d<c.endColIndex+1;d++)b.deleteCol(c.beginColIndex);b=b.table;c=this.selection.getRange();b.getElementsByTagName("td").length?f.inDoc(a,this.document)?c.setStart(a,0).setCursor(!1,!0):
g&&f.inDoc(g,this.document)?c.selectNodeContents(g).setCursor(!1,!0):e&&f.inDoc(e,this.document)&&c.selectNodeContents(e).setCursor(!0,!0):(a=b.nextSibling,f.remove(b),a&&c.setStart(a,0).setCursor(!1,!0))}};UE.commands.splittocells={queryCommandState:function(){var a=w(this),b=a.cell;return!b||0<F(a.table).selectedTds.length?-1:b&&(1<b.colSpan||1<b.rowSpan)?0:-1},execCommand:function(){var a=this.selection.getRange(),b=a.createBookmark(!0),c=w(this).cell;F(c).splitToCells(c);a.moveToBookmark(b).select()}};
