...
.tdLeft { vertical-align:top;width:80px;}
    ...
    <form method="post" action="#{savePostLink}">    
        <table  class="table">
            <tr><td colspan="2" class="formTitle">下拉框验证</td></tr>
            <tr><td class="tdLeft">普通模式</td><td>#{book}
            
            <span class="valid" msg="请填写内容" to="book"></span></td></tr>
    ...
    <form method="post" action="#{savePostLink}">    
        <table  class="table">
            <tr><td colspan="2" class="formTitle">下拉框验证</td></tr>
            <tr><td class="tdLeft">边框模式</td><td>#{music}
            
            <span class="valid border" to="music"></span></td></tr>
