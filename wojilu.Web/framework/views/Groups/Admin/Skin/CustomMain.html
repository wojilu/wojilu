        ...
        <table style="width:100%;">
            <tr>
                ...
                <td style="vertical-align:top;">
                    ...
                    <img src="~js/lib/colorpicker/images/select2.png" class="colorSelector" eleSelector="#groupMainWrap" cssKey="background" />
                    </div>
                     <div style="float:left; margin-left:20px;">
                    <span class="left20 strong">文字颜色</span>
                    <img src="~js/lib/colorpicker/images/select2.png" class="colorSelector" cssKey="color" eleSelector="#groupMain" />
                    </div>
                    <div style="float:left; margin-left:20px;">
                    <span class="left20 strong">链接颜色</span>
                    <img src="~js/lib/colorpicker/images/select2.png" class="colorSelector" cssKey="color" eleSelector="#groupMain a" />
                    </div>
