        ...
        <table style="width:100%;">
            <tr>
                ...
                <td style="vertical-align:top;">
                    ...
                    <img src="~js/lib/colorpicker/images/select2.png" class="colorSelector" eleSelector="#groupHeaderWarp" cssKey="background"/></div>
                    <div style="float:left">
                    <span class="left20 strong">文字颜色</span>
                    <img src="~js/lib/colorpicker/images/select2.png" class="colorSelector" cssKey="color" eleSelector="#groupHeader, #groupHeader a" />
                    </div>

                    
                    <div style="float:left; font-weight:bold; padding-top:5px;margin-left:50px;margin-right:5px;">页头高度</div>
                    <div class="cmdHeight" id="cmdUp" eleSelector="#groupHeader"><img src="~img/up.gif" /></div>
                    <div class="cmdHeight" id="cmdDown" eleSelector="#groupHeader"><img src="~img/dn.gif" /></div>
                    <div id="lblHeight" class="note">请点击箭头调整高度</div>           
                </td>
            </tr>
            <tr>
