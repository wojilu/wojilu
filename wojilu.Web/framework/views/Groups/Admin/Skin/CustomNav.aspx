...
<div style=" margin:10px;">
    ...
    <table class="tabHeader" style="width:96%;" cellpadding="0" cellspacing="0">
	    <td class="otherTab" style="width:2%;"></td>
    ...
    <div style="padding:10px;">
        ...
        <table style="width:100%;">
            <tr>
                <td style="width:60px; vertical-align:;"><b>_{bgColor}</b></td>
                <td style="vertical-align:top;">
                    <div style="float:left">
                    <img src="~js/lib/colorpicker/images/select2.png" class="colorSelector" eleSelector="#groupNavWrap" cssKey="background"/>
                    </div>
                    
                    <div style="float:left">
                    <span class="left20 strong">文字颜色</span>
                    <img src="~js/lib/colorpicker/images/select2.png" class="colorSelector" cssKey="color" eleSelector="#groupNav a" />
                    </div>
                
                    <div style="float:left; font-weight:bold; padding-top:5px;margin-left:50px;margin-right:5px;">菜单高度</div>
                    <div class="cmdHeight" id="cmdUp" eleSelector="#groupNavWrap"><img src="~img/up.gif" /></div>
                    <div class="cmdHeight" id="cmdDown" eleSelector="#groupNavWrap"><img src="~img/dn.gif" /></div>
                    <div id="lblHeight" class="note">请点击箭头调整菜单高度</div>                
