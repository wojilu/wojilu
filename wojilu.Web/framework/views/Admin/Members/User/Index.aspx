...
<table id="tblTools" border="0" cellpadding="4" cellspacing="1" style="width: 100%; font-size:12px;">
	<tr>
		...
		<ul id="baseList" class="menuItems" style="width:150px;">
        ...
        <li><a href="#{userListLink}?filter=AvatarError">头像不符要求</a></li>
        <li><a href="#{userListLink}?filter=bind">已绑定第三方帐号</a></li>	
		</ul>
		</span>
...
<td colspan="11" style=" padding-left:15px;">
		...
		<a href="#{errorPicLink}" class="lnkMsg left10"><img src="~img/user.gif"/> 头像审核</a>
</td>
<td align="center" ><span class="btnCmd" cmd="deletetrue"><img src="~img/delete.gif" /> _{deleteTrue}</span></td>
	...
	<tr class="tableItems">
		...
		<td>#{user.RoleName}</td>
        <td align="center">#{user.PicStatus}</td>
		<td><a href="#{user.Url}" target="_blank">#{user.Name}</a>#{user.RealNameInfo}</td>
		<td><div class="user-ip hide">#{user.Ip}</div></td>
	...
	<!-- END list -->
	<tr><td colspan="12" class="adminPage">
	
		<table style="width: 100%">
			<tr>
				<td>#{page}</td>
				<td align="right">_{note}: &quot;<img src="~img/trash.gif"/>&quot;_{referTrash}；&quot;★&quot;_{referPick}；&quot;--&quot;待审核；
                &quot;<img src="~img/s/external-link.png" />&quot;绑定第三方帐号
                </td>
			</tr>
		</table>
