        ...
        <table style="width:100%;">
            ...
            <tr>
                <td>_{title}</td>
                <td><input name="Title" type="text" style="width:500px;" /><span class="valid border"></span></td>
            </tr>
            <tr>
                <td>_{receiver}</td>
                <td>#{siteRole}</td>
...
<span class="valid border" to="Body"></span>
            ...
            <tr>
                <td>&nbsp;</td>
                <td><input type="submit" name="btnSubmit" value="_{sendSiteMsg}" class="btn" id="btnSubmit" />
