        ...
        <table style="width:100%;">
            <tr>
                ...
                <td style="vertical-align:top;">
                    ...
                    <img src="~js/lib/colorpicker/images/select2.png" class="colorSelector" eleSelector="#page-main-wrap" cssKey="background" />
                    </div>
                     <div style="float:left; margin-left:20px;">
                    <span class="left20 strong">文字颜色</span>
                    <img src="~js/lib/colorpicker/images/select2.png" class="colorSelector" cssKey="color" eleSelector="#page-main-wrap" />
                    </div>
                    <div style="float:left; margin-left:20px;">
                    <span class="left20 strong">链接颜色</span>
                    <img src="~js/lib/colorpicker/images/select2.png" class="colorSelector" cssKey="color" eleSelector="#page-main-wrap a" />
                    </div>
