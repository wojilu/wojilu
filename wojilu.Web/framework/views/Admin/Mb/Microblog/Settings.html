<div>
    ...
    <form method="post" action="#{ActionLink}" class="ajaxPostForm" style="width:700px; margin:auto;">
        ...
        <table class="tblSetting" cellpadding="0" cellspacing="0">
            ...
            <tr>            
                <td class="lblLeft">每条微博最多字数</td>
                <td><input type="text" name="x.MicroblogContentMax" value="#{x.MicroblogContentMax}" style="width:50px;" /></td>
            </tr>

            <tr>            
                <td class="lblLeft">每页显示微博数量</td>
                <td><input type="text" name="x.MicroblogPageSize" value="#{x.MicroblogPageSize}" style="width:50px;" />
                <span class="note">(头条下面的列表数)</span>
                </td>
            </tr>
