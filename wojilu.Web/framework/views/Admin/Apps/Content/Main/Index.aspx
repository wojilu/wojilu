	...
	<div class="" style="padding:10px;">
		<table cellspacing="0" cellpadding="2" border="0" style="width: 100%;" id="dataAdminList" data-action="#{ActionLink}">
			<tr class="adminBar"><td colspan="4">
				<span id="btnPick" class="btnCmd left10 hide" cmd="pick"><img src="~img/pick.gif" /> _{recommend}</span>	
				<span id="btnDelete" class="btnCmd left10" cmd="delete"><img src="~img/delete.gif" /> _{delete}</span>	
			</td>		
