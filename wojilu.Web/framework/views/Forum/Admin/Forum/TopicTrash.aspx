		...
		<table class="tabHeader" style="width:96%; font-size:12px;" cellpadding="0" cellspacing="0">
			...
			<td class="currentTab" style="width:16%"><a href="#{topicTrashLink}">:{topicList}</a></td>
			<td class="otherTab" style="width:16%"><a href="#{postTrashLink}">:{postList}</td>
		...
		<div style="padding:10px;">
			...
			<table cellspacing="1" cellpadding="4" style="width: 100%;" id="dataAdminList" data-action="#{ActionLink}">
				...
				<tr class="tableHeader">
					...
					<td>_{title}</td>
					<td align="center">_{view}/_{comment}</td>
				...
				<tr class="tableItems">
					...
					<td><a href="#{post.MemberUrl}">#{post.MemberName}</a></td>
