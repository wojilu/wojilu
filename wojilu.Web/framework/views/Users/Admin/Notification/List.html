...
<script>
var newNotificationTextId = 'newNotificationText';
var newNotificationPanel = 'viewerNewNotificationCount';
...
_run( function() {
    ...
    $('.nfMsg a').not('.requestUser').each( function() {
	...
	$('.nfMsg a').not('.requestUser').click( function() {
