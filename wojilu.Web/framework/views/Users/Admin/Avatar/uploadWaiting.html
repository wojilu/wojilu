    ...
    <div class="alert alert-error" style="margin-top:10px;">#{errorWraning}</div>
		...
		<table style="width:400px; margin-top: 20px;" border="0">
			<tr>
				<td align="center" valign="top" style="width:150px;">
					<div id="userFace"><div style=" background:#fff; border:3px solid #ccc; height:120px; width:120px; border-radius:5px; color:#aaa; line-height:120px; ">头像不符合要求</div></div>
				</td>
