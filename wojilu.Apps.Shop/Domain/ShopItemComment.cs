...
namespace wojilu.Apps.Shop.Domain {
    ...
    [Serializable]
    public class ShopItemComment : ObjectBase<ShopItemComment>, IComment {
        ...
        private String getTitleData( String lnkPost ) {
            ...
            ShopItem data = ShopItem.findById( this.RootId );
        ...
        public void AddNotification( String lnkTarget ) {
            ShopItem post = ShopItem.findById( this.RootId );
            if (post == null) return;
